...
public interface CommodityGroupRepository
    ...
    Page<CommodityGroup> findRecursiveByParentId(@Param("id") Integer id, @ParameterObject Pageable pageable);
    ...
    Page<NamedEntityLink> getCommodityGroupChildren(@Param("id") Integer id, @ParameterObject Pageable pageable);
