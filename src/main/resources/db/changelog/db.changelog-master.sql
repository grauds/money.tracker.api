...
--changeset anton:1
CREATE OR ALTER VIEW ALL_OPERATIONS_HISTORY (ID, TRANSFERDATE, ACC_ID, AMOUNT, MONEY_SIGN) AS
SELECT *
FROM (
...
--changeset anton:2
CREATE OR ALTER VIEW RECENT_ACCOUNTS_TOTAL (ACC_ID, NAME, BALANCE, TOTAL, CODE) AS
